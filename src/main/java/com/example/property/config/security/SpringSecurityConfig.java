package com.example.property.config.security;

import com.example.property.auth.info.*;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.jdbcAuthentication()
                ...
                .authoritiesByUsernameQuery("select u.username, ur.roles from users u join roles ur on u.id = ur.user_id where u.username = ?")
                .rolePrefix("ROLE_");
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers(ApplicationProperties.API_URL + "/items/**").hasRole(Role.USER.toString())
